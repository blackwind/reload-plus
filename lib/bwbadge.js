(function() {
  module.exports = function(tab) {
    const anonid = require("sdk/self").name + "-badge";
    ...
    badge.setAttribute("style", "background-color: #3A3 !important; color: #FFF !important; font-weight: bold !important; margin: 0px 2px !important; padding: 0px 6px !important; border-radius: 2px !important;");
