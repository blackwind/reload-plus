...
(function() {
  ...
  module.exports = function(tab, backColor = "#3A3", foreColor = "#FFF") {
    ...
    badge.setAttribute("style", "opacity: 0.3; background-color: " + backColor + " !important; border-radius: 2px !important; color: " + foreColor + " !important; font-weight: bold !important; margin: 0px 0px 0px 2px !important; padding: 0px 6px !important; text-decoration: none !important;");
    ...
    return {
      show: function(val) {
        if (val)
          this.setText(val);
          if (val <= 20) badge.style.opacity = "1";
