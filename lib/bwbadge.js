(function() {
  ...
  module.exports = function(tab) {
    if (tab.tagName != "tab" || tab.ownerDocument.getAnonymousElementByAttribute(tab, "anonid", BADGE_ANONID))
      return false;
    ...
    badge.setAttribute("style", "background-color: #3A3 !important; border-radius: 2px !important; color: #FFF !important; font-weight: bold !important; margin: 0px 2px !important; padding: 0px 6px !important;");
